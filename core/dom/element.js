	...
	CKEDITOR.tools.extend( CKEDITOR.dom.element.prototype, {
		...
		getClientRect: function( isAbsolute ) {
			...
			var winGlobalScroll = CKEDITOR.document.getWindow().getScrollPosition(),
				documentRoot = getDocumentRoot( this );

			if ( this.equals( documentRoot ) ) {
				elementRect.top += winGlobalScroll.y;
				elementRect.left += winGlobalScroll.x;
			} else {
				var rootRect = documentRoot.getClientRect();
				elementRect.top += rootRect.top + winGlobalScroll.y;
				elementRect.left += rootRect.left + winGlobalScroll.x;
			}
			...
			function getDocumentRoot( element ) {
				var parent = element.getParent();
				return parent ? getDocumentRoot( parent ) : element;
			}
		},
